...
realtime controller. It accepts the six released telemetry fields only when the
sample has the authoritative `SIMULATED` quality flag.

The UI shows `Simulated demo data`, all six values and units, realtime state,
